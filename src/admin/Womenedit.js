...
const Womenedit = () => {
    ...
    const handleSubmit = (event) => {
        ...
        fetch(`http://localhost:5000/patchwomen/${id}`,{
            method: "PATCH",
            headers:{
        ...
        .then((data) => {
            ...
            window.location.href ="/Admin/Womenadmin";
        });
    ...
    <div className='admin_men_edit'>
        ...
        <div className='women-edit'>
            ...
            <form className='text-title' onSubmit={ handleSubmit }>
                ...
                <button className='btn btn-danger'><Link className="moving-admin" to='/Admin/Womenadmin'><FaBackspace />
                Back</Link> </button>
